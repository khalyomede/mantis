...
::: tip NOTICE
Like routes, middlewares errors are catched and rendered/reported to the [error handler](/0.0.1/http/error-handling).
:::

### After response rendered

You can also alter the response after it has been rendered from your [route callback](/0.0.1/http/routing).
