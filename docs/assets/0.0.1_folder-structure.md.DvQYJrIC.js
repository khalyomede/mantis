import{_ as n,c as a,a3 as p,o as e}from"./chunks/framework.Br0sn5vz.js";const v=JSON.parse('{"title":"Folder structure","description":"","frontmatter":{},"headers":[],"relativePath":"0.0.1/folder-structure.md","filePath":"0.0.1/folder-structure.md"}'),l={name:"0.0.1/folder-structure.md"};function i(t,s,c,o,r,u){return e(),a("div",null,s[0]||(s[0]=[p(`<h1 id="folder-structure" tabindex="-1">Folder structure <a class="header-anchor" href="#folder-structure" aria-label="Permalink to &quot;Folder structure&quot;">​</a></h1><p>Here is an opiniated view of how your app can scale.</p><p>This is just a suggested approach to help you project yourself.</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>your-app</span></span>
